...
$(document).ready(function () {
	...
	user_id = userid;
	targetService = "10.104.207.137:5005";
	// user_id = "jitesh97";
...
function action_trigger() {
	...
	$.ajax({
		url: `http://${targetService}/rasa/conversations/${user_id}/execute`,
		type: "POST",
...
function send(message) {
	...
	var targetService = "10.104.207.137:5005";
	var url = document.location.protocol + "//" + targetService;
	$.ajax({
